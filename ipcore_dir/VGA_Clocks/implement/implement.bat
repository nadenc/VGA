...
xst -ifn xst.scr
move VGA_Clocks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\VGA_Clocks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc VGA_Clocks_exdes.ucf VGA_Clocks_exdes

echo 'Running map'
map -timing -pr b VGA_Clocks_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm VGA_Clocks_exdes -w routed.ncd routed.v
cd ..
